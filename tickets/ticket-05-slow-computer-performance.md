...
![Task Manager Performance](../screenshots/ticket-05-slow-computer-performance/ticket-05-01-task-manager-performance.png)
...
![Startup Apps Before](../screenshots/ticket-05-slow-computer-performance/ticket-05-02-startup-apps-before.png)

Unnecessary startup apps were disabled to reduce login time and background resource usage.

![Startup Apps After](../screenshots/ticket-05-slow-computer-performance/ticket-05-07-startup-apps-after.png)
...
![Disk Space Before](../screenshots/ticket-05-slow-computer-performance/ticket-05-03-disk-space-before.png)
...
![Temporary Files Before Cleanup](../screenshots/ticket-05-slow-computer-performance/ticket-05-04-temp-files-before-cleanup.png)

After cleanup, storage was reviewed again to confirm that temporary files were removed.

![Disk Cleanup After](../screenshots/ticket-05-slow-computer-performance/ticket-05-08-disk-cleanup-after.png)
...
![Windows Update Status](../screenshots/ticket-05-slow-computer-performance/ticket-05-05-windows-update-status.png)
...
![Event Viewer System Log](../screenshots/ticket-05-slow-computer-performance/ticket-05-06-event-viewer-system-log.png)
...
![Final Verification](../screenshots/ticket-05-slow-computer-performance/ticket-05-09-final-verification.png)
